function [Energy Inverse_Difference_Moment]=glcmEnergy_AND_IDM(IG2)
...
%% ALLOCATION
clc;
fx5=strcat('GLCM_PROPERTIES_OF_RETINAL_IMAGES_GREENCHANNEL45', '.txt');
fName=fx5; %# A file name
fid = fopen(fName,'w');            %# Open the file

fx8=('GLCM_PROPERTIES_OF_RETINAL_IMAGES_GREENCHANNEL45'); %ImagesTestSegREAL_AVERAGE_COMBINEMORPHOLOGY3
...
%-------------------------------------------------------------------------%
    str55 = int2str(kat);
    fx2=strcat('MEASUREMENT OF IMAGE: ',str55);
...
%-------------------------------------------------------------------------%
    str = int2str(kat);
    fx2=strcat('MEASUREMENT OF IMAGE: ',str);
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'%s\r\n',fx2);  %# Print the string
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'Energy = %9.5f \r\n',Energy);

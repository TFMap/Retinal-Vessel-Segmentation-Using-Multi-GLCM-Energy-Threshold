%function [Energy_90_Degree IDM_90_Degree]=glcmEnergy_AND_IDM_90_Degree(IG2)
...
IDM_val = zeros(4,1);
fx5=strcat('GLCM_PROPERTIES FOR DIRECTION NINETY DEGREE IN ALL DISTANCES', '.txt');
fName=fx5; %# A file name
fid = fopen(fName,'w');            %# Open the file

fx8=('GLCM_PROPERTIES FOR DIRECTION 90 DEGREE IN ALL DISTANCES'); %ImagesTestSegREAL_AVERAGE_COMBINEMORPHOLOGY3
...
% Difference Entropy
 ...
 Difference_Entropy = f11;
    ...
    str = int2str(kat);
    fx2=strcat('MEASUREMENT OF DIRECTION 90 DEGREE IN DISTANCE ONE OF IMAGE: ',str);
...
% Difference Entropy
 ...
 Difference_Entropy = Difference_Entropy - Difference_Entropy2;
    ...
    str = int2str(kat);
    fx2=strcat('MEASUREMENT OF DIRECTION 90 DEGREE IN DISTANCE TWO OF IMAGE: ',str);
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'%s\r\n',fx2);  %# Print the string
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'Energy = %9.5f \r\n',Energy);
...
% Difference Entropy
 ...
 Difference_Entropy = Difference_Entropy - Difference_Entropy2;
     ...
     str = int2str(kat);
    fx2=strcat('MEASUREMENT OF DIRECTION 90 DEGREE IN DISTANCE THREE OF IMAGE: ',str);
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'%s\r\n',fx2);  %# Print the string
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'Energy = %9.5f \r\n',Energy);
...
% Difference Entropy
 ...
 Difference_Entropy = Difference_Entropy - Difference_Entropy2;
     ...
     str = int2str(kat);
    fx2=strcat('MEASUREMENT OF DIRECTION 90 DEGREE IN DISTANCE FOUR OF IMAGE: ',str);
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'%s\r\n',fx2);  %# Print the string
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'Energy = %9.5f \r\n',Energy);
 ...
 Energy_90_Degree= max(Energy_val)-min(Energy_val); 
 IDM_90_Degree= max(IDM_val)-min(IDM_val); 
    fprintf(fid,'......................................................... \r\n');
    fprintf(fid,'.........................................................\r\n');
    fprintf(fid,'......................................................... \r\n');
    fprintf(fid,'......................................................... \r\n');
    str55 = int2str(kat);
    fx2=strcat('SUMMARY OF DIFFERENCE FOR DIRECTION 90 DEGREE OF IMAGE ',str55);
    fprintf(fid,'_____________________________ \r\n');
    fprintf(fid,'%s\r\n',fx2);  %# Print the string
    fprintf(fid,'_____________________________ \r\n');

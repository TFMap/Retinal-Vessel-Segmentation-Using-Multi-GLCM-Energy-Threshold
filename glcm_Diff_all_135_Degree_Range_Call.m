function [Mean_Contrast_val_135 Diff_Var_val_135_Degree Sum_AVG_val_135_Degree Sum_Entropy_val_135_Degree Contrast_val_135_Degree Diff_Entropy_val_135_Degree Correl_2_val_135_Degree Sum_Var_val_135_Degree Entropy_val_135_Degree ]=glcm_Diff_all_135_Degree_Range_Call(IG2)
...
% Difference Entropy
 ...
 Diff_Var_val_135_Degree = range(Diff_Var_val);
 Sum_AVG_val_135_Degree = abs(range(Sum_AVG_val));
 Sum_Entropy_val_135_Degree = abs(range(Sum_Entropy_val));
 Contrast_val_135_Degree = abs(range(Contrast_val));
 Diff_Entropy_val_135_Degree = abs(range(Diff_Entropy_val));
 Correl_2_val_135_Degree = abs(range(Correl_2_val));
 Sum_Var_val_135_Degree = abs(range(Sum_Var_val));
 Entropy_val_135_Degree = abs(range(Entropy_val));

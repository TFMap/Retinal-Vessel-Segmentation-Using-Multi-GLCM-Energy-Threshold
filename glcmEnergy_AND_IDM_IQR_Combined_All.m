...
IDM_val = zeros(4,1);
fx5=strcat('AVERAGE OF ENERGY AND LOCAL HOMOGENEITY DIFFERENCES FOR ALL DIRECTIONS IQR_Call3', '.txt');
fName=fx5; %# A file name
fid = fopen(fName,'w');            %# Open the file

fx8=('AVERAGE OF ENERGY DIFFERENCES AND LOCAL HOMOGENEITY DIFFERENCES FOR ALL DIRECTIONS IQR_Call3'); %ImagesTestSegREAL_AVERAGE_COMBINEMORPHOLOGY3

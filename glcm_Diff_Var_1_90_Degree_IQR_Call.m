function [Mean_Contrast_val_90 IQR_Diff_Var_val_90_Degree IQR_Sum_AVG_val_90_Degree IQR_Sum_Entropy_val_90_Degree IQR_Contrast_val_90_Degree IQR_Diff_Entropy_val_90_Degree IQR_Correl_2_val_90_Degree IQR_Sum_Var_val_90_Degree IQR_Entropy_val_90_Degree ]=glcm_Diff_Var_1_90_Degree_IQR_Call(IG2)
...
% Difference Entropy
 ...
 IQR_Diff_Var_val_90_Degree = iqr(Diff_Var_val);
 IQR_Sum_AVG_val_90_Degree = abs(iqr(Sum_AVG_val));
 IQR_Sum_Entropy_val_90_Degree = abs(iqr(Sum_Entropy_val));
 IQR_Contrast_val_90_Degree = abs(iqr(Contrast_val));
 IQR_Diff_Entropy_val_90_Degree = abs(iqr(Diff_Entropy_val));
 IQR_Correl_2_val_90_Degree = abs(iqr(Correl_2_val));
 IQR_Sum_Var_val_90_Degree = abs(iqr(Sum_Var_val));
 IQR_Entropy_val_90_Degree = abs(iqr(Entropy_val));
 Mean_Contrast_val_90=Contrast_val/4;